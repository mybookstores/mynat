<template>
    <div class="exchange">
        ...
        <div class="mybutton">
          ...
          <div >
              <button   @click="fetchData('http://localhost:7778/client/closeServer')">关闭</button>
          </div>
        </div>
  ...
  export default {
    ...
    mounted(){
        this.storeData=this.fileStore.get('server');
    ...
    methods:{
        ...
        getMessage3()
      {
        axios.get("http://localhost:7778/client/getMessage3")
          .then(response => {
              // 处理返回的数据
              console.log(response.data);
              if(response.data)
      ...
      sendMessage(){
            ...
            this.fileStore.set('server',data);
            ...
            */
            axios.post('http://localhost:7778/client/openServer', data)
                .then(response => {
                    // 处理返回的数据
                    console.log(response.data);
